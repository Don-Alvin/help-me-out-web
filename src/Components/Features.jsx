const Features = () => {
  return (
    <section id="features" className="p-6 md:p-6 lg:p-[100px] flex flex-col items-center gap-[64px] bg-white my-[56px]">
      ...
      <article className="flex gap-14">
        <div className="flex flex-col gap-12 w-[90%]">
          <div className="flex items-start gap-2">
            ...
            <div>
              <h3 className="text-[22px] md:text-[28px] text-primary-400 font-semibold font-sora">Simple Screen Recording</h3>
              <p className="font-work text-text-grey md:text-[20px]">
          ...
          <img src="images/easy.svg" alt="easy icon" />
            <div>
              <h3 className="text-[22px] md:text-[28px] text-primary-400 font-semibold font-sora">Easy-to-share URL</h3>
              <p className="font-work text-text-grey md:text-[20px]">
          ...
          <img src="images/revisit.svg" alt="revisit icon" />
            <div>
              <h3 className="text-[22px] md:text-[28px] text-primary-400 font-semibold font-sora">Revisit Recordings</h3>
              <p className="font-work text-text-grey md:text-[20px]">
