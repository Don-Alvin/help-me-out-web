  ...
  return (
    <main>
        <header className='shadow pb-6'>
          ...
          <span className='grid md:flex p-6 lg:px-[100px] font-work text-text-grey text-[12px] md:text-[18px]'>Home/ Recent videos/
            <span className='text-primary-400 text-medium'> How To Create A Facebook Ad Listing</span>
          </span>
      </header>
      <section className='p-6 lg:px-[100px] lg:py-8 flex flex-col gap-6 lg:gap-10 '>
        <div className='w-[300px] md-full flex flex-col gap-6'>
            ...
            <div className=' w-[300px] md:w-fullborder border-solid border-gray-200 shadow rounded-lg p-4'>
                <video className='lg:h-[498px] w-full rounded-lg' src="" controls></video>
            </div>
        </div>
        <div className='md:w-full'>
            <div className='w-full grid gap-4  lg:flex lg:ustify-between '>
              <form className='w-[300px] md:w-full bg-primary-50 flex gap-4 lg:w-[40%] items center justify-between p-4 lg:px-6 lg:py-[14px] rounded'>
                <input className='w-full bg-primary-50 rounded  outline-none placeholder:font-work lg:placeholder:text-[18px]' type="email" placeholder='Enter email of the reciever' />
                <button className='bg-primary-300 text-white font-work p-2 lg:px-[18px] lg:py-[14px] rounded'>Send</button>
              </form>
              <form className='w-[300px] md:w-full lg:w-[55%] bg-[#fafafa] border border-solid border-gray-200 flex gap-4  items center justify-between p-4 lg:px-6 lg:py-[14px] rounded'>
                <input className='w-full bg-[#fafafa] rounded  outline-none placeholder:font-work lg:placeholder:text-[18px] font-work lg:text-[18px] text-text-grey' type="text" value='https://www.helpmeout/Untitled_Video_20232509'/>
        ...
        <div className='grid gap-4'>
            ...
            <div className="grid w-full md:flex gap-2">
              <button className='w-[300px] px-4 py-3 flex items-center gap-2 border border-solid border-primary-main rounded-md'>
                  <FaFacebook />
